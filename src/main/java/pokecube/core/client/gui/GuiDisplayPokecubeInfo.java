...
public class GuiDisplayPokecubeInfo extends Gui
{
    ...
    public void drawSelected(GuiEvent.RenderSelectedInfo evt)
    {
        ...
        applyTransform(PokecubeMod.core.getConfig().guiRef, PokecubeMod.core.getConfig().guiPos, guiDims,
        ...
        if (pokemob != null)
        {
            ...
            float total = pokemob.getMaxHealth();
            ...
            for (moveIndex = 0; moveIndex < 4; moveIndex++)
            {
                ...
                boolean disabled = index >= 0 && index < 4 && pokemob.getDisableTimer(index) > 0;
                if (move != null)
                {
                    GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
                    // bind texture
    ...
    public void drawTarget(GuiEvent.RenderTargetInfo evt)
    {
        ...
        GL11.glPushMatrix();
        GL11.glColor4f(1, 1, 1, 1);
        applyTransform(PokecubeMod.core.getConfig().targetRef, PokecubeMod.core.getConfig().targetPos, targetDims,
